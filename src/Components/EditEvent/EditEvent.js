...
const EditEvent = () => {
  ...
  return (
    <div className="lg:w-3/5 mx-auto">
      ...
      >
        <div>
          <label>Event Name - Birthday Bash</label>
          <input
        ...
        <div>
          <label>Start time - 6:00 PM</label>
          <input
            type="time"
            className="border-2 border-indigo-500 w-full rounded-md py-3 px-2"
            {...register("startTime", {
        ...
        <div>
          <label>Start date - 18 August 2022</label>
          <input
            type="date"
            className="border-2 border-indigo-500 w-full rounded-md py-3 px-2"
            {...register("startDate", {
        ...
        <div>
          <label>End date - 19 August 2022</label>
          <input
            type="date"
            className="border-2 border-indigo-500 w-full rounded-md py-3 px-2"
            {...register("endDate", {
        ...
        <div>
          <label>Location time - Suburb, State, Postcode</label>
          <input
            className="border-2 border-indigo-500 w-full rounded-md py-3 px-2"
            {...register("location", {
              required: {
